...
package body Text_Format is
   ...
   is
      use HAL;
   begin
      return Hex (UInt8 (Shift_Right (Data, 24) and 16#FF#)) &
             Hex (UInt8 (Shift_Right (Data, 16) and 16#FF#)) &
             Hex (UInt8 (Shift_Right (Data, 8) and 16#FF#)) &
             Hex (UInt8 (Shift_Right (Data, 0) and 16#FF#));
   end Hex;
